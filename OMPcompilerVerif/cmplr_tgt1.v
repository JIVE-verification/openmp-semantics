...
Module Info.
  ...
  Definition source_file := "cmplr_tgt1.c".
End Info.
...
Definition f__par_routine1 := {|
  ...
  fn_vars := ((__par_routine1_data,
              ...
              (__i, (tptr tint)) :: (_j, tint) :: (_k, tint) :: (_l, tint) ::
              nil);
  fn_body :=
(Ssequence
  (Sdo (Eassign
      ...
      (Ssequence
        (Sdo (Ecall
               (Evalof
                 ...
                 (Tfunction (Tcons (tptr (Tstruct _atom_int noattr)) Tnil)
                   tvoid cc_default))
               (Econs
                 (Eaddrof
                   (Evar _critical_mutex_1 (tptr (Tstruct _atom_int noattr)))
                   (tptr (tptr (Tstruct _atom_int noattr)))) Enil) tvoid))
        (Ssequence
          (Sdo (Epostincr Incr
            ...
            (Ssequence
              ...
              (Ssequence
                (Sdo (Eassign (Evar _k tint) (Eval (Vint (Int.repr 1)) tint)
                       tint))
                (Ssequence
                  (Sdo (Eassign (Evar _l tint)
                         (Eval (Vint (Int.repr 0)) tint) tint))
                  (Ssequence
                    (Sdo (Ecall
                           (Evalof
                             (Evar _acquire (Tfunction
                           ...
                           (Econs
                             (Eaddrof
                               (Evar _reduction_mutex_1 (tptr (Tstruct _atom_int noattr)))
                                   ...
                                   (Evalof
                                     (Efield
                                       (Evalof
                                         ...
                                         (Tstruct __par_routine1_data_ty noattr))
                                       _k (tptr tint)) (tptr tint)) tint)
                                 tint) (Evalof (Evar _k tint) tint) tint)
                             tint))
                      (Ssequence
                        (Sdo (Ecall
                               (Evalof
...
Definition f_main := {|
  ...
  fn_callconv := cc_default;
  fn_params := nil;
  fn_vars := ((_lock_1, (tptr (Tstruct _atom_int noattr))) ::
              (_lock_2, (tptr (Tstruct _atom_int noattr))) :: (_i, tint) ::
              (_j, tint) :: (_k, tint) ::
              (___par_routine1_data_1,
               (Tstruct __par_routine1_data_ty noattr)) ::
              (___par_routine1_data_2,
               (Tstruct __par_routine1_data_ty noattr)) :: (_t2, tint) ::
              nil);
  fn_body :=
(Ssequence
  (Ssequence
    (Sdo (Eassign (Evar _lock_1 (tptr (Tstruct _atom_int noattr)))
           (Ecall
             (Evalof
               (Evar _makelock (Tfunction Tnil
                                 (tptr (Tstruct _atom_int noattr))
                                 cc_default))
               (Tfunction Tnil (tptr (Tstruct _atom_int noattr)) cc_default))
             Enil (tptr (Tstruct _atom_int noattr)))
           (tptr (Tstruct _atom_int noattr))))
    (Ssequence
      (Sdo (Eassign (Evar _lock_2 (tptr (Tstruct _atom_int noattr)))
             (Ecall
               (Evalof
                 (Evar _makelock (Tfunction Tnil
                                   (tptr (Tstruct _atom_int noattr))
                                   cc_default))
                 (Tfunction Tnil (tptr (Tstruct _atom_int noattr))
                   cc_default)) Enil (tptr (Tstruct _atom_int noattr)))
             (tptr (Tstruct _atom_int noattr))))
      (Ssequence
        ...
        (Ssequence
          ...
          (Ssequence
            (Sdo (Eassign (Evar _k tint) (Eval (Vint (Int.repr 0)) tint)
                   tint))
            (Ssequence
              (Sdo (Eassign
                     (Efield
                       (Evalof
                         ...
                         (Tstruct __par_routine1_data_ty noattr)) _i
                       (tptr tint)) (Eaddrof (Evar _i tint) (tptr tint))
                     (tptr tint)))
              (Ssequence
                (Sdo (Eassign
                       (Efield
                         ...
                         (tptr tint)) (Eaddrof (Evar _k tint) (tptr tint))
                       (tptr tint)))
                (Ssequence
                  (Sdo (Eassign
                         (Efield
                    ...
                    (Sdo (Eassign
                           (Efield
                             (Evalof
                               ...
                               (Tstruct __par_routine1_data_ty noattr)) _k
                             (tptr tint))
                           (Eaddrof (Evar _k tint) (tptr tint)) (tptr tint)))
                    (Ssequence
                      (Sdo (Eassign (Evar _t2 tint)
                             (Ecall
                               (Evalof
                               ...
                               (Econs
                                 (Evalof
                                   (Evar __par_routine1 (Tfunction
                                                          ...
                                                          (tptr tvoid)
                                                          cc_default))
                                   (Tfunction (Tcons (tptr tvoid) Tnil)
                               ...
                               (Econs
                                 (Ecast
                                   (Eaddrof
                                     (Evar ___par_routine1_data_1 (Tstruct __par_routine1_data_ty noattr))
                                     (tptr (Tstruct __par_routine1_data_ty noattr)))
                                   (tptr tvoid)) Enil) (tptr tvoid)))
                        (Ssequence
                          (Sdo (Ecall
                                 (Evalof
                                   (Evar _join_thread (Tfunction
                                                        (Tcons tint Tnil)
                                                        tvoid cc_default))
                                   (Tfunction (Tcons tint Tnil) tvoid
                                     cc_default))
                                 (Econs (Evalof (Evar _t2 tint) tint) Enil)
                                 tvoid))
                          (Ssequence
                            (Sdo (Ecall
                                   (Evalof
                                     ...
                                     (Tfunction (Tcons (tptr tschar) Tnil)
                                       tint
                                       {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|}))
                                   (Econs
                                     (Evalof
                                     ...
                                     (Econs (Evalof (Evar _i tint) tint)
                                       (Econs (Evalof (Evar _j tint) tint)
                                         (Econs (Evalof (Evar _k tint) tint)
                                           Enil)))) tint))
                            (Ssequence
                              (Sdo (Ecall
                                     (Evalof
                                     ...
                                     (Econs
                                       (Evalof
                                         (Evar _lock_1 (tptr (Tstruct _atom_int noattr)))
                                         (tptr (Tstruct _atom_int noattr)))
                                       Enil) tvoid))
                              (Ssequence
                                (Sdo (Ecall
                                       ...
                                       (Econs
                                         (Evalof
                                           (Evar _lock_2 (tptr (Tstruct _atom_int noattr)))
                                           (tptr (Tstruct _atom_int noattr)))
                                         Enil) tvoid))
...
((___compcert_va_int32,
 ...
 (_join_thread,
   Gfun(External (EF_external "join_thread"
                   (mksignature (AST.Tint :: nil) AST.Tvoid cc_default))
     (Tcons tint Tnil) tvoid cc_default)) ::
 (_critical_mutex_1, Gvar v_critical_mutex_1) ::
 (_reduction_mutex_1, Gvar v_reduction_mutex_1) ::
 (__par_routine1, Gfun(Internal f__par_routine1)) ::
 (_main, Gfun(Internal f_main)) :: nil).

Definition public_idents : list ident :=
(_main :: __par_routine1 :: _reduction_mutex_1 :: _critical_mutex_1 ::
 _join_thread :: _spawn :: _release :: _acquire :: _freelock :: _makelock ::
