...
Fixpoint stmt_to_stmtT (stmt: statement) : statementT :=
  ...
  | Ssequence s1 s2 => SsequenceT (parse_parallel_info_stmt s1) (parse_parallel_info_stmt s2)
  | Sifthenelse e s1 s2 => SifthenelseT e (parse_parallel_info_stmt s1) (parse_parallel_info_stmt s2)
  | Sloop s1 s2 => SloopT (parse_parallel_info_stmt s1) (parse_parallel_info_stmt s2)
  | Sbreak => SbreakT
